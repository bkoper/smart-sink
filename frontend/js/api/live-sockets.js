...
import {hotSensorActions, coldSensorActions, hotAlertActions, coldAlertActions} from '../actions/app-actions';
import config from '../constants/config';
import constants from '../constants/general';


const socket = io.connect(`http://${config.WEBSOCKET_IP}:${config.WEBSOCKET_PORT}`);
